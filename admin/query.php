...
<div id="content">
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <script>
      function markAsRead(que_id) {
        if(confirm("Do you really want to mark this as read?")) {
          $.ajax({
            url: 'update_query_status.php', // Create this file to handle the update
            type: 'POST',
            data: { id: que_id },
              ...
              <tr>
                ...
                <td>
                  <?php if ($row['query_status'] == 1) { ?>
                    Read
                  <?php } else { ?>
                    <a href="javascript:void(0);" onclick="markAsRead(<?php echo $row['query_id']; ?>)"><b>Pending</b></a>
                  <?php } ?>
                </td>
